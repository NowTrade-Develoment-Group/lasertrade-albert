...
module.exports = async () => {
    try {
        try {
            logger("info", "Database", `Host (${config.database.host}) creating...`);
            logger("info", "Database", `User (${config.database.user}) creating...`);
            logger("info", "Database", `Password (${config.database.pass}) creating...`);
            ...
            logger("info", "Database", `DBName (${config.database.name}) creating...`);
