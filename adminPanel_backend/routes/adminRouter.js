...
router.get("/getPermissions", adminmiddleware, adminControl.getPermissions);
router.post("/createPermission", adminmiddleware, adminControl.createPermission);
router.post("/deletePermission", adminmiddleware, adminControl.deletePermission);
